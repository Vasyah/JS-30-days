...
// get all elements
var d = document;
var video = d.querySelector('.viewer');
var player = d.querySelector('.player');
var progress = d.querySelector('.progress');
var progressBar = d.querySelector('.progress__filled');
var playButton = d.querySelector('.toggle');
var ranges = d.querySelectorAll('.player__slider');
var skipButtons = d.querySelectorAll('[data-skip'); // assign all listeners
...
function togglePlay() {
  var event = video.paused ? 'play' : 'pause';
  video[event]();
}

function changePlayIcon() {
  var playIcon = this.paused ? '►' : '❚ ❚';
...
function scrub(e) {
  var curr = e.offsetX / progress.offsetWidth * video.duration;
  console.log(curr);
