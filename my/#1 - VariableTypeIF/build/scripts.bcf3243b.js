...
// }
var userAnsw = prompt('');
var userArr = userAnsw.split(''); // for(let i = 0; i < userArr.length; i++){
//     if(userArr[i] % 2 === 0){
//         document.write(userArr[i]);
//     }
// }

userArr.forEach(function (item, index, arr) {
  return console.log("\u041C\u0430\u0441\u0441\u0438\u0432 ".concat(arr, " \u044D\u043B\u0435\u043C\u0435\u043D\u0442 ").concat(index, "=").concat(item, "\n"));
});
console.log(userArr);
